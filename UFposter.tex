...
\psshadowbox{\makebox[0.95\textwidth]{%
    ...
    \parbox[c]{0.7\linewidth}{%
      \begin{center}
		...
		Tomas Staig$^{1}$, Daniel A. Bustamante$^{1}$,\\ Camilo E. Menay$^{1}$,
		Mauricio A. Araya$^{2}$ and Horst H. von Brand$^{1}$}\\[0.3em]
		{ $^1$Computer Systems Research Group, Universidad T\'ecnica
		Federico Santa Mar\'ia (UTFSM), Valpara\'iso, Chile}\\
		{ $^2$Institut National de Recherche en Informatique et Automatique (INRIA), France}
      \end{center}}
	\hfill
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{spalte}
      ...
      \begin{kasten}
		\section*{\hspace{0.1cm} {\color{red} Problem}}
        \subsection*{\hspace{0.2cm} {\color{blue} Description}}
			\begin{minipage}[t]{0.95\linewidth}
Dummy content\\
			\end{minipage}

        \subsection*{\hspace{0.2cm} {\color{blue} Dummy title}}
...
%			\hspace{-0.8cm}
%			\includegraphics[width=1\linewidth,height=!]{images/seq-LBSim}
%			\end{minipage} \hfill
%\hspace{-0.805\linewidth}
			\begin{minipage}[t]{0.95\linewidth}
Dummy content\\
			\end{minipage}
      \end{kasten}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{spalte}
      ...
      \begin{kasten}
        \section*{\hspace{0.1cm} {\color{red} Dummy title}}
			\begin{minipage}[t]{0.95\linewidth}
Dummy content\\
			\end{minipage}\vfill
			\begin{minipage}[t]{0.95\linewidth}
...
telescope control model'' in [{\em Proceedings of SPIE - Advanced Software
and Control for Astronomy 2008}{\hspace{0.1em}}], (2008).
\renewcommand{\baselinestretch}{0.5}
}
\hfill
\end{minipage}
