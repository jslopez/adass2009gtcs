...
{\newrgbcolor{gradbegin}{0.5 0.5 1}
  ...
  %\rput[cm](15.23,-15){
  \rput[tl]{0}(-0.2,0.1){
  \includegraphics[height=\paperheight,width=!]{images/antena1}
  }
\vfill}
...
Each observatory has successfully developed a wide spectrum of TCS solutions for
...
within a Chilean University''}, under development at Universidad T\'ecnica
...
[5] Chiozzi, G., ``An object-oriented event-driven architecture for the VLT
Telescope Control Software'' in [{\em Proceedings of ICALEPCS 1995
}{\hspace{0.1em}}], (1995).
\renewcommand{\baselinestretch}{0.5}
...
\begin{minipage}[t]{0.10\linewidth}
	\begin{tabular}{c}
	\includegraphics[width=!,height=1.5cm]{images/authorpic}
	\end{tabular}
\end{minipage}
}}\hfill\mbox{}
...
For more information about ALMA development and research at UTFSM Computer
